...
Node {
    ...
    readonly property alias removeTimer: removeTimer
    ...
    function useTargets(immediate) {
        ...
        if (killtarget) {
            const targets = world.find("targetname", killtarget);
